        ...
        for (i = 0; i < location.length; i++) {
          ...
          google.maps.event.addListener(marker, 'click', (function (marker, i) {
            return function () {
              ...
              infowindow.setContent('<div style="font-size:9px;"><strong>Latitud:</strong> ' + location[i].latitud + '</br><strong>Longitud:</strong> ' + location[i].latitud + '</br><strong>Red:</strong> ' + location[i].nombreRed + '</br><strong>Contraseña: </strong> ' + location[i].passwordRed +'</div>');
